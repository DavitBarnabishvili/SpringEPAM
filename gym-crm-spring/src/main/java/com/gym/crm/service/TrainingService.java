...
public interface TrainingService {
     ...
     */
    Training createTraining(String username, String password, Training training);
     ...
     */
    List<Training> findTrainingsByTraineeId(String username, String password, Long traineeId);
     ...
     */
    List<Training> findTrainingsByTrainerId(String username, String password, Long trainerId);
    ...
    List<Training> findTraineeTrainingsByDateRange(String username, String password, Long traineeId, LocalDate startDate, LocalDate endDate);

    List<Training> findTrainerTrainingsByDateRange(String username, String password, Long trainerId, LocalDate startDate, LocalDate endDate);
